...
This document details the different phases of the project. The phases are detailed in a descending order, starting from the final phase. 
...
Below are detailed the main changes made in the final phase. The final features of the project can be seen in the readme.md document. 

**Main changes in Final Phase**
 - Cyber security was updated (CSRF - vulnerabilities have been addressed)
 - Code has been checked and refactored
 - An option to filter messages based on volunteer name has been included
 - Volunteer's activity level can be changes
 - UI has been polished
 - Log-information has been added 
 - Error-handling has been improved
 - Message view was rebuilt. Now replies to reported activities are embedded in the original post. Pagination is based on volunteer-messages.
 - An option to request for a reply was introduced. Notification for active requests was added. 
 - Account information can be now updated. Password can be changed
 - Error handling and validation was improved. Flash messages were added to the application
 - Report view was improved. 
